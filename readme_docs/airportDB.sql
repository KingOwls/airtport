...
CREATE TABLE `planes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `planes` varchar(30) DEFAULT NULL,
...
CREATE TABLE `flight_connections` (
  ...
  KEY `fk_departure_airport` (`departure_airport`),
  KEY `fk_arrival_airport` (`arrival_airport`),
  CONSTRAINT `fk_departure_airport` FOREIGN KEY (`departure_airport`) REFERENCES `airports` (`id`),
  CONSTRAINT `fk_arrival_airport` FOREIGN KEY (`arrival_airport`) REFERENCES `airports` (`id`),
...
INSERT INTO `airlines` VALUES (1,'American Airlines'),(2,'Delta Air Lines'),(3,'United Airlines'),(4,'Southwest Airlines'),(5,'JetBlue Airways'),(6,'Alaska Airlines'),(7,'Spirit Airlines'),(8,'Frontier Airlines'),(9,'Hawaiian Airlines'),(10,'Allegiant Air');
...
CREATE TABLE `trips` (
  `id` int NOT NULL AUTO_INCREMENT,
  `trip_date` date DEFAULT NULL,
  `price_trip` double DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_customers_document` (`id_document`),
  CONSTRAINT `fk_customers_document` FOREIGN KEY (`id_document`) REFERENCES `documenttypes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `employees` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_role_employee` (`id_role`),
  KEY `fk_airline_employee` (`id_airline`),
  KEY `fk_airport_employee` (`id_airport`),
  CONSTRAINT `fk_airline_employee` FOREIGN KEY (`id_airline`) REFERENCES `airlines` (`id`),
  CONSTRAINT `fk_airport_employee` FOREIGN KEY (`id_airport`) REFERENCES `airports` (`id`),
  CONSTRAINT `fk_role_employee` FOREIGN KEY (`id_role`) REFERENCES `tripulationroles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `models` (
  ...
  CONSTRAINT `fk_model_manufacturer` FOREIGN KEY (`manufacturer_id`) REFERENCES `manufacturers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `planes` (
  ...
  `id_model` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_plane_name` (`name`),
  KEY `fk_status_plane` (`id_status`),
  KEY `fk_model_plane` (`id_model`),
  CONSTRAINT `fk_model_plane` FOREIGN KEY (`id_model`) REFERENCES `models` (`id`),
  CONSTRAINT `fk_status_plane` FOREIGN KEY (`id_status`) REFERENCES `statuses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `gates` (
  ...
  `id_airport` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_airport_gate` (`id_airport`),
  CONSTRAINT `fk_airport_gate` FOREIGN KEY (`id_airport`) REFERENCES `airports` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
